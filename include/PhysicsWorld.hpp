...
public:
    ...
    // ── 登記 / 移除 ───────────────────────────────────────────────────────
    void Register(std::shared_ptr<IPhysicsBody> body);
    ...
    // 回傳所有指定類型的 body
    std::vector<IPhysicsBody*> GetBodiesOfType(BodyType type) const;
...
private:
    // ── 工具 ─────────────────────────────────────────────────────────────
    bool AabbOverlaps(const IPhysicsBody* a, const IPhysicsBody* b) const;
    ...
    // ── 內部更新步驟 ──────────────────────────────────────────────────────
    void StepPhysicsUpdate();   // 呼叫所有 body 的 PhysicsUpdate()
